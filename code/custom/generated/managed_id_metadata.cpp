...
lake_color_index_command = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("lake_color_index_command"));
lake_color_index_namespace = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("lake_color_index_namespace"));
lake_color_member_variable = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("lake_color_member_variable"));
}
